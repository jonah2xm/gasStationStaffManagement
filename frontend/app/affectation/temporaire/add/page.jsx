    ...
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen text-gray-800">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">
          Ajouter une Affectation Temporaire
        </h1>
        <Button
          variant="outline"
      ...
      <Card className="max-w-4xl mx-auto bg-white">
        <CardHeader>
          <CardTitle>Enregistrer une Affectation Temporaire</CardTitle>
          <CardDescription>
            Saisissez les informations relatives à l'affectation temporaire d'un
            employé.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <SelectContent>
                      {stations
                        .filter(
                          (station) => station !== formData.originalStationId
                        )
                        .map((station) => (
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-green-600 flex items-center gap-2">
              ...
              Affectation Temporaire Enregistrée avec Succès
            </AlertDialogTitle>
            <AlertDialogDescription>
              L'affectation temporaire a été enregistrée avec succès pour{" "}
              {selectedPersonnel?.firstName} {selectedPersonnel?.lastName} de{" "}
              {formData.originalStationId} vers {formData.temporaryStation}.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
