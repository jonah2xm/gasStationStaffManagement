...
// Circuit des stations : documents imprimés → Agence COM Oran.
                    ...
                    <TableRow key={b._id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-1.5">
                          ...
                          {b.recu ? (
                            // Réceptionné par le gestionnaire : l'envoi ne peut plus être annulé.
                            <span
                              className="inline-flex h-9 items-center px-3 text-[13px] text-muted-foreground"
                              title="Déjà réceptionné par le gestionnaire : ce bordereau ne peut plus être annulé."
                            >
                              Réceptionné
                            </span>
                          ) : (
